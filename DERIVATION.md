...
| manifested_as канон (роды делателя) | #460 | writing → Decision 2b; product-roadmap → actor-modeling rules (Step 2); whoami → skeleton §2b (people of the contours, agantuka rule) | a род or its addressing/steward rule changes |
