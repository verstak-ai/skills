...
**Then weigh the ask before you make it.** A boundary you may not cross is real; a boundary you would simply rather not cross is an errand you are outsourcing. Asking is never free to the other side — it enters their queue, displaces their work, and comes back on their cadence rather than yours — so before asking a neighbouring contour to change, ask what it would cost to absorb on your own side, and when the answer is *little*, absorb it. Three things make the ask the right move instead, and each is checkable: the cost would not disappear but **move and multiply** — something rare becoming something frequent; you would have to **reproduce a relation you don't own**, so your copy drifts from theirs the first time either moves; or your local version would **teach a wrong model** to everyone who reads it next. Name which one holds when you ask. If none does, you are asking a neighbour to spare you an hour.
