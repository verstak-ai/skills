...
- **Agent karta**: `#931 «👨‍💻 Разработчик скилл-репозиториев агента»` — adhikarin, steward of #844 (also stewards the iskron/skills fork #1506). Your inbox: `nks_orient(realm="r5", focus="931")` at session start. No seq recorded here → the repo is not verstakified; run verstakify before acting.
